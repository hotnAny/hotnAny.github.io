...
var ControlPanel = function () {
	...
	container.style.cssText = 'width:256px;height:100%;overflow:hidden;opacity:0.5;font-family:Helvetica;background-color:#D9D4D0;color:#262b2f';
	// container.innerHTML = "<div>Polka</div>"

	var txtTitle = document.createElement( 'div' );
	txtTitle.id = 'title';
	txtTitle.style.cssText = 'margin-left:3px;margin-top:5px;overflow:inherit;color:#262b2f;font-family:Helvetica,Arial,sans-serif;font-size:10px;line-height:15px';
	txtTitle.innerHTML = '<b>Tympana</b>';
	container.appendChild( txtTitle );

	var cssBtn = 'margin-left:3px;margin-top:5px;padding:1px 3px 1px 3px;font-family:Helvetica;border-radius:5px;font-size:10px;line-height:15px;text-align:left;background-color:#D9D4D0';
	...
	*/
	...
	btnAction1.innerHTML = 'Analyze printability';
	...
	*/
	...
	outputText.style.cssText = 'height:100%;width:270;margin-left:0px;border-width:0px;margin-top:5px;margin-bottom:15px;margin-right:50px;white-space:pre-wrap;overflow:inherit;color:#262b2f;background-color:#D9D4D0;font-family:Helvetica,Arial,sans-serif;font-size:10px;line-height:15px;';
